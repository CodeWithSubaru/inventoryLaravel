                ...
                <div class="col-xl-6 col-lg-8 col-md-10">
                    <div class="breadcrumb__wrap__content">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('organizatory') }}">Home</a></li>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="standard__blog__post">
                        <div class="standard__blog__thumb">
                            ...
                            <a href="{{ route('organizatory.blog-details', $blog->id) }}" class="blog__link"><i class="far fa-long-arrow-right"></i></a>
                        </div>
                        <div class="standard__blog__content">
                            ...
                            <h2 class="title"><a href="{{ route('organizatory.blog-details', $blog->id) }}">{{ $blog->name }}</a></h2>
                    ...
                    <aside class="blog__sidebar">
                            ...
                            <ul class="rc__post">
                                ...
                                <li class="rc__post__item">
                                    ...
                                    <div class="rc__post__content">
                                        <h5 class="title"><a href="{{ route('organizatory.blog-details', $blog->id) }}">{{ $blog->title }}</a></h5>
                        ...
                        <div class="widget">
                            ...
                            <ul class="sidebar__cat">
                                ...
                                <li class="sidebar__cat__item"><a href="{{ route('organizatory.blog-category', $category->id) }}">{{ $category->name }}</a></li>
                                @endforeach
                            </ul>
                        </div>
                        <div class="widget">
