...
<head>
    ...
    <meta charset="utf-8" />
    <title>Recover Password | Organizatory</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="Organizatory" name="description" />
    <meta content="Organizatory" name="author" />
    <!-- App favicon -->
                ...
                <div class="card-body">
                    ...
                    <div class="p-3">
                        ...
                        <form method="POST" class="form-horizontal mt-3" action="{{ route('password.email') }}">
                            ...
                            <!-- Session Status -->
                            <x-auth-session-status class="mb-4" style="color: #16a34a;" :status="session('status')" />
